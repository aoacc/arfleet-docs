...
There are several standards involved, and the storage looks like a nested doll consisting of several layers.

Care is needed to align all layers precisely.

## ArFleet Reassembly Protocol

Before we begin: multiple times we have to operate on chunks of data of different sizes. There are two challenges associated with this:
...
This extra information is stored using ArFleet Reassembly Protocol.
